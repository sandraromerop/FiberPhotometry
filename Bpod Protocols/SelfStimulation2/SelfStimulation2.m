...
function SelfStimulation2

% SETUP
% You will need:
% - A Bpod MouseBox (or equivalent) configured with 3 ports.
% > Connect the left port in the box to Bpod Port#4.
% > Connect the center port in the box to Bpod Port#5.
% > Connect the right port in the box to Bpod Port#6.
% > Make sure the liquid calibration tables for ports 4 and 6 have
...
for currentTrial = 1:MaxTrials
    ...
    if S.GUI.LaserSide==1
        laser_arg = {'Port4In','Laser','Port6In','ShamLaser','Tup','exit'};
        LaserOFF_arg = {'Tup', 'Drinking','Port6In','Drinking'};
        ShamLaserOFF_arg = {'Tup', 'Drinking','Port4In','Drinking'};
    elseif S.GUI.LaserSide==2
        laser_arg = {'Port4In','ShamLaser','Port6In','Laser','Tup','exit'};
        LaserOFF_arg= {'Tup', 'Drinking','Port4In','Drinking'};
        ShamLaserOFF_arg = {'Tup', 'Drinking','Port6In','Drinking'};
    end
    ...
    switch S.GUI.TrainingLevel
        case 1 % Habituation
            ...
            sma = AddState(sma, 'Name', 'Laser', ...
                'Timer', S.GUI.LaserDuration,...
                'StateChangeConditions', LaserOFF_arg,...
                'OutputActions', {'BNC1', 1});
            sma = AddState(sma, 'Name', 'ShamLaser', ...
                'Timer', S.GUI.LaserDuration,...
                'StateChangeConditions', ShamLaserOFF_arg,...
                'OutputActions', {});
